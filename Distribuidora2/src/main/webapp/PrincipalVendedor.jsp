...
<html lang="en">
    ...
    <body style="background-color:black;">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <a class="navbar-brand" href="PrincipalVendedor.jsp" >Distribuidora</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  <!--  <li class="nav-item active">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=ClientesVendedor&accion=Listar" target="miContenedor">Clientes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=ArticulosVendedor&accion=Listar" target="miContenedor">Articulos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=Pedidos&accion=Listar" target="miContenedor">Pedidos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=TipoArticuloVendedor&accion=Listar" target="miContenedor">Tipo Articulo</a>
                    </li>
