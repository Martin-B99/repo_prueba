    ...
    <body>
        <div class="row">
            <div class="card col-md-4">
                <div class="card-body">
                    <h5 class="card-title" align="center">Clientes</h5>
                    <h6 class="card-subtitle mb-2 text-muted" align="center">En este panel podras gestionar los datos de los Clientes</h6>
                    <center>
  						<img alt="logo" src="cliente.png"  width="200" height="200" >
   					</center>
                    <div>
